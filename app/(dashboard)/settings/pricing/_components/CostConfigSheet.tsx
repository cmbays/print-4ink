...
export function CostConfigSheet({
  ...
  const preview = useMemo(() => {
    ...
    const inkCost = draft.inkCostPerHit * SAMPLE_ORDER.colors * SAMPLE_ORDER.locations;
    const overheadRate = draft.shopOverheadRate / 100;
    ...
    const laborCost = draft.laborRate ? draft.laborRate * (30 / 3600) : 0;
    const totalCost = garmentCost + inkCost + overheadCost + laborCost;
