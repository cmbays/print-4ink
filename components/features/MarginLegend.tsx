...
const items = [
  {
    ...
    label: 'Healthy',
    threshold: '\u226530%',
    tooltip: 'Margin is 30% or above \u2014 price comfortably covers costs',
  },
  {
    color: 'bg-warning',
    label: 'Caution',
    threshold: '15\u201330%',
    tooltip: 'Margin is 15\u201330% \u2014 covers costs but leaves little room for error',
  },
  {
    color: 'bg-error',
    label: 'Unprofitable',
    threshold: '<15%',
    tooltip: 'Margin is below 15% \u2014 may not cover ink, labor, and overhead',
  },
] as const

type MarginLegendProps = {
