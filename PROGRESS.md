...
**Status**: Both verticals (Quoting + Customer Management) built and polished. Ready for demo.
...
- Vitest (264 tests, 12 test files), GitHub Actions CI
- Layout shell: sidebar (6 nav links) + topbar + main content area
...
<details><summary>Quoting Vertical (PRs #13, #14, #20 — all merged)</summary>

- Quotes List (`/quotes`) — DataTable with status tabs, search, sort, row actions
...
- Sticky top bar, tooltip system, pricing formula display, per-location decoration fees
</details>

<details><summary>Customer Management (PRs #24, #33, #35 — all merged)</summary>
