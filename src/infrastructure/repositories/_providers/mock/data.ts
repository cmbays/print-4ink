...
export const contacts: Contact[] = [
  ...
  {
    id: '04d5e6f7-a8b9-4c0d-ae2f-3a4b5c6d7e8f',
    name: 'Jake Thompson',
  ...
  // Sunset 5K — 1 contact
  {
    id: '05e6f7a8-b9c0-4d1e-bf3a-4b5c6d7e8f9a',
    name: 'Maria Gonzalez',
  ...
  {
    id: '06f7a8b9-c0d1-4e2f-8a4b-5c6d7e8f9a0b',
    name: 'Chris Patel',
  ...
  {
    id: '07a8b9c0-d1e2-4f3a-9b5c-6d7e8f9a0b1c',
    name: 'Amy Wong',
  ...
  {
    id: '08b9c0d1-e2f3-4a4b-ac6d-7e8f9a0b1c2d',
    name: 'Coach Williams',
  ...
  {
    id: '09c0d1e2-f3a4-4b5c-bd7e-8f9a0b1c2d3e',
    name: 'Janet Lee',
  ...
  {
    id: '10d1e2f3-a4b5-4c6d-8e8f-9a0b1c2d3e4f',
    name: 'Alex Kim',
  ...
  {
    id: '11e2f3a4-b5c6-4d7e-9f0a-1b2c3d4e5f6a',
    name: 'Pastor James',
  ...
  {
    id: '12f3a4b5-c6d7-4e8f-a01b-2c3d4e5f6a7b',
    name: 'Mike Davis',
  ...
  {
    id: '13a4b5c6-d7e8-4f9a-b12c-3d4e5f6a7b8c',
    name: 'Tom Rodriguez',
...
export const customerGroups: Group[] = [
  ...
  {
    id: '92b3c4d5-e6f7-4a8b-9c0d-1e2f3a4b5c6d',
    name: 'Admin',
...
export const customerNotes: Note[] = [
  // River City Brewing — 3 notes (1 pinned)
  {
    ...
    content: 'Prefers Comfort Colors for all casual wear. Always wants black or forest green.',
    createdAt: '2025-10-15T14:30:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: 'in-person',
    entityType: 'customer',
    entityId: CUSTOMER_IDS.riverCity,
  },
  {
    id: '62b3c4d5-e6f7-4a8b-9c0d-1e2f3a4b5c6d',
    content:
      'Marcus called about spring order. Wants same design as last year but with updated date.',
  ...
  {
    id: '63c4d5e6-f7a8-4b9c-8d1e-2f3a4b5c6d7e',
    content: 'Referred Jake Thompson — family reunion order.',
  ...
  {
    id: '64d5e6f7-a8b9-4c0d-ae2f-3a4b5c6d7e8f',
    content:
      'Tax exempt — certificate on file, expires 2027-03-31. Net 30 payment terms per contract.',
    createdAt: '2025-06-01T10:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.lonestar,
  },
  {
    id: '65e6f7a8-b9c0-4d1e-bf3a-4b5c6d7e8f9a',
    content: 'Sarah confirmed tournament dates for Feb 22. Rush delivery needed by Feb 20.',
  ...
  {
    id: '66f7a8b9-c0d1-4e2f-8a4b-5c6d7e8f9a0b',
    content: 'One-time order — family reunion. Referred by Marcus Rivera at River City Brewing.',
    createdAt: '2026-02-05T09:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.thompson,
  },
  {
    id: '67a8b9c0-d1e2-4f3a-9b5c-6d7e8f9a0b1c',
    content: 'Jake approved the design over email. Wants youth sizes included.',
  ...
  {
    id: '68b9c0d1-e2f3-4a4b-ac6d-7e8f9a0b1c2d',
    content: 'Budget-conscious — declined first quote at $4,500. Try to keep under $3,000.',
    createdAt: '2026-01-30T16:30:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.sunset5k,
  },
  {
    id: '69c0d1e2-f3a4-4b5c-bd7e-8f9a0b1c2d3e',
    content: 'Maria asked about 1-color option to reduce cost. Sent revised quote.',
  ...
  {
    id: '70d1e2f3-a4b5-4c6d-8e8f-9a0b1c2d3e4f',
    content:
      'Chris is the main decision-maker. Amy handles all billing. Always reach Chris first for creative decisions.',
    createdAt: '2025-09-10T14:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: 'in-person',
    entityType: 'customer',
    entityId: CUSTOMER_IDS.lakeside,
  },
  {
    id: '71e2f3a4-b5c6-4d7e-9f0a-1b2c3d4e5f6a',
    content:
      "Haven't heard from Chris in a while. Last order was October. Should follow up about spring festival merch.",
  ...
  {
    id: '72f3a4b5-c6d7-4e8f-a01b-2c3d4e5f6a7b',
    content:
      'Seasonal orders: spring jerseys (Feb-Mar) and fall tournament gear (Aug-Sep). Tax exempt — school district.',
    createdAt: '2025-08-01T09:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.metroYouth,
  },
  {
    id: '73a4b5c6-d7e8-4f9a-b12c-3d4e5f6a7b8c',
    content:
      'Coach Williams prefers to text for quick questions. Janet handles all POs and invoicing.',
  ...
  {
    id: '74b5c6d7-e8f9-4a0b-812c-3d4e5f6a7b8c',
    content:
      'Storefront customer — has online merch store. Fast turnaround is critical for trending content.',
    createdAt: '2025-11-01T10:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.tiktokMerch,
  },
  {
    id: '75c6d7e8-f9a0-4b1c-923d-4e5f6a7b8c9d',
    content: 'Alex wants to explore DTF for small batch runs. Schedule a sample session.',
  ...
  {
    id: '76d7e8f9-a0b1-4c2d-a34e-5f6a7b8c9d0e',
    content: 'Referred by Lonestar Lacrosse (Sarah Chen). First order — VBS t-shirts.',
    createdAt: '2026-01-20T10:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.riverside,
  },
  {
    id: '77e8f9a0-b1c2-4d3e-b45f-6a7b8c9d0e1f',
    content: 'Pastor James mentioned they do 3-4 events per year. Could become a repeat customer.',
  ...
  {
    id: '78f9a0b1-c2d3-4e4f-860a-7b8c9d0e1f2a',
    content:
      'Wholesale account — another print shop. Contract pricing at 15% off. Overflow work for their large orders.',
    createdAt: '2025-05-01T09:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.crosstown,
  },
  {
    id: '79a0b1c2-d3e4-4f5a-971b-8c9d0e1f2a3b',
    content:
      "Mike sends work our way when they're at capacity. Good relationship — reliable payment.",
  ...
  {
    id: '80b1c2d3-e4f5-4a6b-a82c-9d0e1f2a3b4c',
    content:
      'Athletic director exploring new vendors. Currently uses a competitor. Tax exempt — ISD.',
    createdAt: '2026-02-03T09:00:00Z',
    createdBy: 'Gary',
    isPinned: true,
    channel: null,
    entityType: 'customer',
    entityId: CUSTOMER_IDS.mountainView,
  },
  {
    id: '81c2d3e4-f5a6-4b7c-b93d-0e1f2a3b4c5d',
    content: 'Tom requested a sample quote for spring sports. Baseball and track teams.',
...
export const jobs: Job[] = [
  ...
  // -----------------------------------------------------------------------
  {
    ...
    tasks: [
      {
        id: 'd1a00001-e5f6-4a01-8b01-0d1e2f3a4b01',
      ...
      {
        id: 'd1a00002-e5f6-4a01-8b01-0d1e2f3a4b02',
      ...
      {
        id: 'd1a00003-e5f6-4a01-8b01-0d1e2f3a4b03',
      ...
      {
        id: 'd1a00004-e5f6-4a01-8b01-0d1e2f3a4b04',
      ...
      {
        id: 'd1a00005-e5f6-4a01-8b01-0d1e2f3a4b05',
      ...
      {
        id: 'd1a00006-e5f6-4a01-8b01-0d1e2f3a4b06',
      ...
      {
        id: 'd1a00007-e5f6-4a01-8b01-0d1e2f3a4b07',
      ...
      {
        id: 'd1a00008-e5f6-4a01-8b01-0d1e2f3a4b08',
    ...
    history: [{ fromLane: 'ready', toLane: 'in_progress', timestamp: '2026-02-03T09:00:00Z' }],
    notes: [
      {
        id: 'e1a00001-e5f6-4a01-8b01-0d1e2f3a4b01',
        type: 'system',
        content: 'Job created from Quote Q-1024',
        author: 'System',
        createdAt: '2026-02-01T10:00:00Z',
      },
      {
        id: 'e1a00002-e5f6-4a01-8b01-0d1e2f3a4b02',
        type: 'internal',
        content: 'Using 230 mesh for detail work on front center',
        author: 'Gary',
        createdAt: '2026-02-04T11:30:00Z',
      },
      {
        id: 'e1a00003-e5f6-4a01-8b01-0d1e2f3a4b03',
        type: 'internal',
        content: 'Marcus wants same design as spring 2025 run',
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    printLocations: [{ position: 'Front Center', colorCount: 6, artworkApproved: true }],
    complexity: { locationCount: 1, garmentVariety: 1 },
    tasks: [
      {
        id: 'd1b00001-e5f6-4a02-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1b00002-e5f6-4a02-8b02-0d1e2f3a4b02',
        label: 'Gang sheet prepared',
        isCompleted: true,
        completedAt: '2026-02-09T09:00:00Z',
        isCanonical: true,
        sortOrder: 1,
      },
      {
        id: 'd1b00003-e5f6-4a02-8b03-0d1e2f3a4b03',
        label: 'DTF printed',
        isCompleted: true,
      ...
      {
        id: 'd1b00004-e5f6-4a02-8b04-0d1e2f3a4b04',
      ...
      {
        id: 'd1b00005-e5f6-4a02-8b05-0d1e2f3a4b05',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 4,
      ...
      {
        id: 'd1b00006-e5f6-4a02-8b06-0d1e2f3a4b06',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
    ...
    orderTotal: 750,
    artworkIds: [],
    history: [{ fromLane: 'ready', toLane: 'in_progress', timestamp: '2026-02-08T10:00:00Z' }],
    notes: [
      {
        id: 'e1b00001-e5f6-4a02-8b01-0d1e2f3a4b01',
        type: 'internal',
        content: 'Rush job — Alex needs these for pop-up this weekend',
        author: 'Gary',
        createdAt: '2026-02-07T16:30:00Z',
      },
      {
        id: 'e1b00002-e5f6-4a02-8b02-0d1e2f3a4b02',
        type: 'customer',
        content: 'Can we add 10 more? Same design, XL only',
        author: 'Alex Kim',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    garmentDetails: [
      {
        garmentId: 'gc-001',
        colorId: 'clr-white',
        sizes: { S: 30, M: 80, L: 100, XL: 60, '2XL': 30 },
      },
    ],
    printLocations: [
    ...
    tasks: [
      {
        id: 'd1c00001-e5f6-4a03-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1c00002-e5f6-4a03-8b02-0d1e2f3a4b02',
        label: 'Film positives printed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 1,
      ...
      {
        id: 'd1c00003-e5f6-4a03-8b03-0d1e2f3a4b03',
        label: 'Screens burned',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 2,
      ...
      {
        id: 'd1c00004-e5f6-4a03-8b04-0d1e2f3a4b04',
        label: 'Screens registered on press',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 3,
      ...
      {
        id: 'd1c00005-e5f6-4a03-8b05-0d1e2f3a4b05',
        label: 'Blanks received and counted',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 4,
      ...
      {
        id: 'd1c00006-e5f6-4a03-8b06-0d1e2f3a4b06',
        label: 'Press run complete',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
      ...
      {
        id: 'd1c00007-e5f6-4a03-8b07-0d1e2f3a4b07',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 6,
      ...
      {
        id: 'd1c00008-e5f6-4a03-8b08-0d1e2f3a4b08',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 7,
    ...
    notes: [
      {
        id: 'e1c00001-e5f6-4a03-8b01-0d1e2f3a4b01',
        type: 'system',
        content: 'Job created from Quote Q-1025',
        author: 'System',
        createdAt: '2026-02-06T14:00:00Z',
      },
      {
        id: 'e1c00002-e5f6-4a03-8b02-0d1e2f3a4b02',
        type: 'internal',
        content: 'Large order — 300 pcs. Need to confirm blank availability with supplier',
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    garmentDetails: [
      {
        garmentId: 'gc-001',
        colorId: 'clr-royal',
        sizes: { YS: 10, YM: 30, YL: 30, S: 30, M: 25, L: 15, XL: 10 },
      },
    ],
    printLocations: [{ position: 'Left Chest', colorCount: 3, artworkApproved: false }],
    complexity: { locationCount: 1, garmentVariety: 1 },
    tasks: [
      {
        id: 'd1d00001-e5f6-4a04-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
        completedAt: '2026-02-02T10:00:00Z',
        isCanonical: true,
      ...
      {
        id: 'd1d00002-e5f6-4a04-8b02-0d1e2f3a4b02',
        label: 'Design digitized',
        detail: 'Stitch file created',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 1,
      },
      {
        id: 'd1d00003-e5f6-4a04-8b03-0d1e2f3a4b03',
      ...
      {
        id: 'd1d00004-e5f6-4a04-8b04-0d1e2f3a4b04',
        label: 'Blanks received and counted',
        isCompleted: true,
      ...
      {
        id: 'd1d00005-e5f6-4a04-8b05-0d1e2f3a4b05',
      ...
      {
        id: 'd1d00006-e5f6-4a04-8b06-0d1e2f3a4b06',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
      ...
      {
        id: 'd1d00007-e5f6-4a04-8b07-0d1e2f3a4b07',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 6,
    ...
    notes: [
      {
        id: 'e1d00001-e5f6-4a04-8b01-0d1e2f3a4b01',
        type: 'system',
        content: 'Job moved to Blocked — waiting on vendor',
        author: 'System',
        createdAt: '2026-02-06T09:00:00Z',
      },
      {
        id: 'e1d00002-e5f6-4a04-8b02-0d1e2f3a4b02',
        type: 'internal',
        content: 'Called vendor, stitch file promised by Wed 2/12',
        author: 'Gary',
        createdAt: '2026-02-10T11:00:00Z',
      },
      {
        id: 'e1d00003-e5f6-4a04-8b03-0d1e2f3a4b03',
        type: 'customer',
        content: "Coach Williams asked for status update — told him we're waiting on vendor",
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    printLocations: [{ position: 'Front Center', colorCount: 2, artworkApproved: true }],
    complexity: { locationCount: 1, screenCount: 2, garmentVariety: 1 },
    tasks: [
      {
        id: 'd1e00001-e5f6-4a05-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
        completedAt: '2026-02-02T10:00:00Z',
        isCanonical: true,
      ...
      {
        id: 'd1e00002-e5f6-4a05-8b02-0d1e2f3a4b02',
        label: 'Film positives printed',
        isCompleted: true,
      ...
      {
        id: 'd1e00003-e5f6-4a05-8b03-0d1e2f3a4b03',
        label: 'Screens burned',
        isCompleted: true,
      ...
      {
        id: 'd1e00004-e5f6-4a05-8b04-0d1e2f3a4b04',
        label: 'Screens registered on press',
        isCompleted: true,
      ...
      {
        id: 'd1e00005-e5f6-4a05-8b05-0d1e2f3a4b05',
        label: 'Blanks received and counted',
        isCompleted: true,
      ...
      {
        id: 'd1e00006-e5f6-4a05-8b06-0d1e2f3a4b06',
        label: 'Press run complete',
        isCompleted: true,
      ...
      {
        id: 'd1e00007-e5f6-4a05-8b07-0d1e2f3a4b07',
        label: 'QC inspection passed',
        isCompleted: true,
      ...
      {
        id: 'd1e00008-e5f6-4a05-8b08-0d1e2f3a4b08',
        label: 'Packed and labeled',
        isCompleted: true,
    ...
    notes: [
      {
        id: 'e1e00001-e5f6-4a05-8b01-0d1e2f3a4b01',
        type: 'system',
        content: 'All tasks complete — moved to Review',
        author: 'System',
        createdAt: '2026-02-10T15:30:00Z',
      },
      {
        id: 'e1e00002-e5f6-4a05-8b02-0d1e2f3a4b02',
        type: 'internal',
        content: 'Pint Night promo — Marcus wants these for Friday event',
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    garmentDetails: [
      {
        ...
        sizes: { YM: 3, YL: 3, S: 4, M: 5, L: 5, XL: 3, '2XL': 2 },
      },
    ],
    printLocations: [{ position: 'Front Center', colorCount: 4, artworkApproved: true }],
    complexity: { locationCount: 1, screenCount: 4, garmentVariety: 1 },
    tasks: [
      {
        id: 'd1f00001-e5f6-4a06-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1f00002-e5f6-4a06-8b02-0d1e2f3a4b02',
        label: 'Film positives printed',
        isCompleted: true,
        completedAt: '2026-01-27T09:00:00Z',
        isCanonical: true,
        sortOrder: 1,
      },
      {
        id: 'd1f00003-e5f6-4a06-8b03-0d1e2f3a4b03',
        label: 'Screens burned',
        isCompleted: true,
      ...
      {
        id: 'd1f00004-e5f6-4a06-8b04-0d1e2f3a4b04',
        label: 'Screens registered on press',
        isCompleted: true,
      ...
      {
        id: 'd1f00005-e5f6-4a06-8b05-0d1e2f3a4b05',
        label: 'Blanks received and counted',
        isCompleted: true,
      ...
      {
        id: 'd1f00006-e5f6-4a06-8b06-0d1e2f3a4b06',
        label: 'Press run complete',
        isCompleted: true,
        completedAt: '2026-02-03T17:00:00Z',
        isCanonical: true,
        sortOrder: 5,
      },
      {
        id: 'd1f00007-e5f6-4a06-8b07-0d1e2f3a4b07',
        label: 'QC inspection passed',
        isCompleted: true,
      ...
      {
        id: 'd1f00008-e5f6-4a06-8b08-0d1e2f3a4b08',
        label: 'Packed and labeled',
        isCompleted: true,
        completedAt: '2026-02-05T15:00:00Z',
        isCanonical: true,
    ...
    notes: [
      {
        id: 'e1f00001-e5f6-4a06-8b01-0d1e2f3a4b01',
        type: 'system',
        content: 'Job created from Quote Q-1026',
        author: 'System',
        createdAt: '2026-01-25T09:00:00Z',
      },
      {
        id: 'e1f00002-e5f6-4a06-8b02-0d1e2f3a4b02',
        type: 'internal',
        content: 'Shipped via UPS, tracking #1Z999AA10123456784',
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    garmentDetails: [
      {
        garmentId: 'gc-005',
        colorId: 'clr-black',
        sizes: { S: 50, M: 125, L: 150, XL: 100, '2XL': 50, '3XL': 25 },
      },
    ],
    printLocations: [
      { position: 'Front Center', colorCount: 3, artworkApproved: true },
    ...
    tasks: [
      {
        id: 'd1000001-e5f6-4a07-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1000002-e5f6-4a07-8b02-0d1e2f3a4b02',
        label: 'Film positives printed',
        isCompleted: true,
      ...
      {
        id: 'd1000003-e5f6-4a07-8b03-0d1e2f3a4b03',
        label: 'Screens burned',
        isCompleted: true,
      ...
      {
        id: 'd1000004-e5f6-4a07-8b04-0d1e2f3a4b04',
        label: 'Screens registered on press',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 3,
      ...
      {
        id: 'd1000005-e5f6-4a07-8b05-0d1e2f3a4b05',
        label: 'Blanks received and counted',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 4,
      ...
      {
        id: 'd1000006-e5f6-4a07-8b06-0d1e2f3a4b06',
        label: 'Press run complete',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
      ...
      {
        id: 'd1000007-e5f6-4a07-8b07-0d1e2f3a4b07',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 6,
      ...
      {
        id: 'd1000008-e5f6-4a07-8b08-0d1e2f3a4b08',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 7,
    ...
    history: [{ fromLane: 'ready', toLane: 'in_progress', timestamp: '2026-02-01T09:00:00Z' }],
    notes: [
      {
        id: 'e1000001-e5f6-4a07-8b01-0d1e2f3a4b01',
        type: 'internal',
        content: 'Behind schedule — blanks delayed from supplier, ETA 2/13',
        author: 'Gary',
        createdAt: '2026-02-10T09:00:00Z',
      },
      {
        id: 'e1000002-e5f6-4a07-8b02-0d1e2f3a4b02',
        type: 'customer',
        content:
          'Chris asking daily for update. Festival is 2/22, needs buffer for volunteer distribution',
        author: 'Gary',
        createdAt: '2026-02-11T10:00:00Z',
      },
      {
        id: 'e1000003-e5f6-4a07-8b03-0d1e2f3a4b03',
        type: 'internal',
        content: 'May need overtime weekend press run to make deadline',
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    tasks: [
      {
        id: 'd1100001-e5f6-4a08-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1100002-e5f6-4a08-8b02-0d1e2f3a4b02',
        label: 'Gang sheet prepared',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 1,
      ...
      {
        id: 'd1100003-e5f6-4a08-8b03-0d1e2f3a4b03',
        label: 'DTF printed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 2,
      ...
      {
        id: 'd1100004-e5f6-4a08-8b04-0d1e2f3a4b04',
        label: 'Transfers pressed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 3,
      ...
      {
        id: 'd1100005-e5f6-4a08-8b05-0d1e2f3a4b05',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 4,
      ...
      {
        id: 'd1100006-e5f6-4a08-8b06-0d1e2f3a4b06',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
    ...
    notes: [
      {
        id: 'e1100001-e5f6-4a08-8b01-0d1e2f3a4b01',
        type: 'system',
        content: 'Job created from accepted Quote Q-1027',
        author: 'System',
        createdAt: '2026-02-10T10:00:00Z',
      },
    ],
  ...
  // -----------------------------------------------------------------------
  {
    ...
    garmentDetails: [
      {
        garmentId: 'gc-002',
        colorId: 'clr-navy',
        sizes: { S: 20, M: 50, L: 60, XL: 40, '2XL': 20, '3XL': 10 },
      },
    ],
    printLocations: [{ position: 'Left Chest', colorCount: 2, artworkApproved: true }],
    complexity: { locationCount: 1, garmentVariety: 1 },
    tasks: [
      {
        id: 'd1200001-e5f6-4a09-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
        completedAt: '2026-02-02T10:00:00Z',
        isCanonical: true,
      ...
      {
        id: 'd1200002-e5f6-4a09-8b02-0d1e2f3a4b02',
        label: 'Design digitized',
        detail: 'Stitch file created',
        isCompleted: true,
        completedAt: '2026-02-04T14:00:00Z',
      ...
      {
        id: 'd1200003-e5f6-4a09-8b03-0d1e2f3a4b03',
        label: 'Digitizer machine set up',
        isCompleted: true,
        completedAt: '2026-02-05T09:00:00Z',
        isCanonical: true,
      ...
      {
        id: 'd1200004-e5f6-4a09-8b04-0d1e2f3a4b04',
        label: 'Blanks received and counted',
        isCompleted: true,
      ...
      {
        id: 'd1200005-e5f6-4a09-8b05-0d1e2f3a4b05',
        label: 'Embroidery run complete',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 4,
      ...
      {
        id: 'd1200006-e5f6-4a09-8b06-0d1e2f3a4b06',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
      ...
      {
        id: 'd1200007-e5f6-4a09-8b07-0d1e2f3a4b07',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 6,
    ...
    notes: [
      {
        id: 'e1200001-e5f6-4a09-8b01-0d1e2f3a4b01',
        type: 'internal',
        content: 'Wholesale overflow order for CrossTown. Standard logo placement',
        author: 'Gary',
        createdAt: '2026-02-01T10:30:00Z',
      },
      {
        id: 'e1200002-e5f6-4a09-8b02-0d1e2f3a4b02',
        type: 'internal',
        content: 'Running 200 pcs in batches of 50, currently on batch 2',
        author: 'Gary',
        createdAt: '2026-02-10T11:00:00Z',
      },
    ],
  ...
  // -----------------------------------------------------------------------
  {
    ...
    garmentDetails: [
      {
        garmentId: 'gc-002',
        colorId: 'clr-white',
        sizes: { S: 8, M: 20, L: 25, XL: 17, '2XL': 10 },
      },
    ],
    printLocations: [
    ...
    tasks: [
      {
        id: 'd1300001-e5f6-4a10-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1300002-e5f6-4a10-8b02-0d1e2f3a4b02',
        label: 'Film positives printed',
        isCompleted: true,
      ...
      {
        id: 'd1300003-e5f6-4a10-8b03-0d1e2f3a4b03',
        label: 'Screens burned',
        isCompleted: true,
        completedAt: '2026-01-21T09:00:00Z',
        isCanonical: true,
        sortOrder: 2,
      },
      {
        id: 'd1300004-e5f6-4a10-8b04-0d1e2f3a4b04',
        label: 'Screens registered on press',
        isCompleted: true,
      ...
      {
        id: 'd1300005-e5f6-4a10-8b05-0d1e2f3a4b05',
        label: 'Blanks received and counted',
        isCompleted: true,
      ...
      {
        id: 'd1300006-e5f6-4a10-8b06-0d1e2f3a4b06',
        label: 'Press run complete',
        isCompleted: true,
        completedAt: '2026-01-27T17:00:00Z',
        isCanonical: true,
        sortOrder: 5,
      },
      {
        id: 'd1300007-e5f6-4a10-8b07-0d1e2f3a4b07',
        label: 'QC inspection passed',
        isCompleted: true,
        completedAt: '2026-01-28T10:00:00Z',
        isCanonical: true,
      ...
      {
        id: 'd1300008-e5f6-4a10-8b08-0d1e2f3a4b08',
        label: 'Packed and labeled',
        isCompleted: true,
    ...
    notes: [
      {
        id: 'e1300001-e5f6-4a10-8b01-0d1e2f3a4b01',
        type: 'internal',
        content: 'Simple 2+1 color job. Pastor James very happy with result',
        author: 'Gary',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    tasks: [
      {
        id: 'd1400001-e5f6-4a11-8b01-0d1e2f3a4b01',
        label: 'Art files finalized',
        isCompleted: true,
      ...
      {
        id: 'd1400002-e5f6-4a11-8b02-0d1e2f3a4b02',
        label: 'Gang sheet prepared',
        isCompleted: true,
        completedAt: '2026-02-10T14:00:00Z',
        isCanonical: true,
      ...
      {
        id: 'd1400003-e5f6-4a11-8b03-0d1e2f3a4b03',
        label: 'DTF printed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 2,
      ...
      {
        id: 'd1400004-e5f6-4a11-8b04-0d1e2f3a4b04',
        label: 'Transfers pressed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 3,
      ...
      {
        id: 'd1400005-e5f6-4a11-8b05-0d1e2f3a4b05',
        label: 'QC inspection passed',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 4,
      ...
      {
        id: 'd1400006-e5f6-4a11-8b06-0d1e2f3a4b06',
        label: 'Packed and labeled',
        isCompleted: false,
        isCanonical: true,
        sortOrder: 5,
    ...
    orderTotal: 525,
    artworkIds: [],
    history: [{ fromLane: 'ready', toLane: 'in_progress', timestamp: '2026-02-10T09:00:00Z' }],
    notes: [
      {
        id: 'e1400001-e5f6-4a11-8b01-0d1e2f3a4b01',
        type: 'internal',
        content: 'Rush interrupt — Alex needs another batch ASAP, different design on white blanks',
        author: 'Gary',
        createdAt: '2026-02-10T08:00:00Z',
      },
      {
        id: 'e1400002-e5f6-4a11-8b02-0d1e2f3a4b02',
        type: 'customer',
        content: 'This is for the Saturday Austin pop-up, same booth as the black tees',
        author: 'Alex Kim',
...
export const garmentCatalog: GarmentCatalog[] = [
  ...
  },
  {
    ...
    basePrice: 28.0,
    availableColors: ['clr-black', 'clr-navy', 'clr-charcoal', 'clr-forest-green'],
    availableSizes: [
      { name: 'S', order: 0, priceAdjustment: 0 },
      { name: 'M', order: 1, priceAdjustment: 0 },
      { name: 'L', order: 2, priceAdjustment: 0 },
  ...
  },
  {
    ...
    baseCategory: 'outerwear',
    basePrice: 55.0,
    availableColors: ['clr-black', 'clr-navy'],
    availableSizes: [
      { name: 'S', order: 0, priceAdjustment: 0 },
      { name: 'M', order: 1, priceAdjustment: 0 },
      { name: 'L', order: 2, priceAdjustment: 0 },
  ...
  },
  {
    ...
    baseCategory: 'pants',
    basePrice: 10.0,
    availableColors: ['clr-black', 'clr-navy', 'clr-charcoal', 'clr-heather-grey'],
    availableSizes: [
      { name: 'S', order: 0, priceAdjustment: 0 },
      { name: 'M', order: 1, priceAdjustment: 0 },
      { name: 'L', order: 2, priceAdjustment: 0 },
  ...
  },
  {
    ...
    baseCategory: 'pants',
    basePrice: 22.0,
    availableColors: ['clr-black', 'clr-navy', 'clr-heather-grey', 'clr-charcoal'],
    availableSizes: [
      { name: 'S', order: 0, priceAdjustment: 0 },
      { name: 'M', order: 1, priceAdjustment: 0 },
      { name: 'L', order: 2, priceAdjustment: 0 },
  ...
  },
  {
    ...
    baseCategory: 'headwear',
    basePrice: 5.0,
    availableColors: ['clr-black', 'clr-white', 'clr-navy', 'clr-charcoal', 'clr-red', 'clr-royal'],
    availableSizes: [{ name: 'One Size', order: 0, priceAdjustment: 0 }],
    isEnabled: true,
    isFavorite: false,
  },
  ...
  },
  {
    ...
    baseCategory: 't-shirts',
    basePrice: 12.0,
    availableColors: ['clr-black', 'clr-white', 'clr-navy', 'clr-red', 'clr-royal', 'clr-charcoal'],
    availableSizes: [
      { name: 'S', order: 0, priceAdjustment: 0 },
      { name: 'M', order: 1, priceAdjustment: 0 },
      { name: 'L', order: 2, priceAdjustment: 0 },
...
export const quotes: Quote[] = [
    ...
    lineItems: [
      {
        ...
        serviceType: 'screen-print',
        printLocationDetails: [{ location: 'Front', colorCount: 4, setupFee: 0 }],
        unitPrice: 12.0,
        lineTotal: 780,
      },
    ],
  ...
  },
  {
    ...
    lineItems: [
      ...
      },
      {
        ...
        serviceType: 'screen-print',
        printLocationDetails: [{ location: 'Front', colorCount: 2, setupFee: 0 }],
        unitPrice: 8.0,
        lineTotal: 1200,
      },
    ],
  ...
  },
  {
    ...
    subtotal: 7417.5,
    total: 6857.5,
    discounts: [{ label: 'Volume Discount — 500+ units', amount: 600, type: 'volume' }],
    shipping: 0,
    tax: 0,
    dtfLineItems: [],
    dtfSheetCalculation: null,
    ...
    status: 'revised',
    internalNotes:
      'Second revision. Chris asked for hoodie option and volunteer tees. Gave volume discount.',
  ...
  },
  {
    ...
    subtotal: 1040,
    total: 1030,
    discounts: [{ label: 'Repeat Customer — 5% off', amount: 52, type: 'manual' }],
    shipping: 0,
    tax: 2,
    dtfLineItems: [],
    dtfSheetCalculation: null,
...
export const invoices: Invoice[] = [
  // INV-0001: River City Brewing, from Q-1024, PAID ($765), 2 payments
  {
    ...
    lineItems: [
      ...
      {
        id: 'd3c30102-e5f6-4a01-8b02-0d1e2f3a4d02',
        type: 'setup',
        description: 'Screen setup — front + back (5 colors)',
        quantity: 1,
        unitPrice: 40,
        lineTotal: 40,
      },
    ...
    auditLog: [
      ...
      { action: 'sent', performedBy: 'Gary', timestamp: '2026-01-12T09:00:00Z' },
      {
        ...
        details: 'Check #1042 — $400.00',
      },
      {
        action: 'payment_recorded',
        performedBy: 'Gary',
        timestamp: '2026-01-18T14:00:00Z',
        details: 'Square — $365.00',
      },
    ],
    reminders: [],
  },
  ...
  // INV-0002: Lonestar Lacrosse, from Q-1025, SENT / OVERDUE (27 days), $2,614
  {
    ...
    lineItems: [
      {
        id: 'd3c30201-e5f6-4a01-8b03-0d1e2f3a4d03',
        type: 'garment',
        description: 'Bella+Canvas 3001 — White (65 pcs)',
        quantity: 65,
        unitPrice: 22.0,
        lineTotal: 1430,
      },
      {
        id: 'd3c30202-e5f6-4a01-8b04-0d1e2f3a4d04',
        type: 'garment',
        description: 'Bella+Canvas 3001 — Navy (65 pcs)',
        quantity: 65,
        unitPrice: 22.0,
        lineTotal: 1430,
      },
      {
        id: 'd3c30203-e5f6-4a01-8b05-0d1e2f3a4d05',
        type: 'setup',
        description: 'Screen setup — 3 locations (4 colors)',
        quantity: 1,
        unitPrice: 40,
        lineTotal: 40,
      },
    ...
    reminders: [
      {
        ...
        message: 'Friendly reminder: Invoice INV-0002 for $2,614.00 was due on Jan 15.',
      },
    ],
  },
  ...
  // INV-0003: Thompson Family, from Q-1026, DRAFT, $855
  {
    ...
    lineItems: [
      {
        id: 'd3c30301-e5f6-4a01-8b06-0d1e2f3a4d06',
        type: 'garment',
        description: 'Bella+Canvas 3001 — Heather Grey (65 pcs)',
        quantity: 65,
        unitPrice: 12.0,
        lineTotal: 780,
      },
      {
        id: 'd3c30302-e5f6-4a01-8b07-0d1e2f3a4d07',
        type: 'setup',
        description: 'Screen setup — front (4 colors)',
        quantity: 1,
        unitPrice: 40,
        lineTotal: 40,
      },
    ...
    auditLog: [{ action: 'created', performedBy: 'Gary', timestamp: '2026-02-08T09:00:00Z' }],
    reminders: [],
  },
  ...
  // INV-0004: River City Brewing, standalone (Holiday Merch), PAID ($1,850), 3 payments
  {
    ...
    lineItems: [
      {
        id: 'd3c30401-e5f6-4a01-8b08-0d1e2f3a4d08',
        type: 'garment',
        description: 'Gildan 18500 Hoodie — Forest Green (53 pcs)',
        quantity: 53,
        unitPrice: 32.0,
        lineTotal: 1696,
      },
      {
        id: 'd3c30402-e5f6-4a01-8b09-0d1e2f3a4d09',
        type: 'setup',
        description: 'Screen setup — front + back (6 colors)',
        quantity: 1,
        unitPrice: 54,
        lineTotal: 54,
      },
    ...
    auditLog: [
      ...
      },
      {
        ...
        details: 'Venmo — $500.00',
      },
      {
        action: 'payment_recorded',
        performedBy: 'Gary',
        timestamp: '2025-12-18T16:00:00Z',
        details: 'Credit Card — $750.00',
      },
      {
        action: 'credit_memo_issued',
        performedBy: 'Gary',
        timestamp: '2026-01-05T10:00:00Z',
        details: 'CM-0001 shortage — $96.00',
      },
    ],
    reminders: [],
  },
  ...
  // INV-0005: Lonestar Lacrosse, standalone, PARTIAL ($840, $500 paid, $340 due)
  {
    ...
    lineItems: [
      {
        id: 'd3c30501-e5f6-4a01-8b0a-0d1e2f3a4d0a',
        type: 'garment',
        description: 'New Balance Dry Fit — White (40 pcs)',
        quantity: 40,
        unitPrice: 18.0,
        lineTotal: 720,
      },
      {
        id: 'd3c30502-e5f6-4a01-8b0b-0d1e2f3a4d0b',
        type: 'setup',
        description: 'Screen setup — 2 locations',
        quantity: 1,
        unitPrice: 40,
        lineTotal: 40,
      },
    ...
    auditLog: [
      ...
      { action: 'sent', performedBy: 'Gary', timestamp: '2026-01-17T09:00:00Z' },
      {
        ...
        details: 'Check #2088 — $300.00',
      },
      {
        action: 'payment_recorded',
        performedBy: 'Gary',
        timestamp: '2026-02-07T11:00:00Z',
        details: 'Zelle — $200.00',
      },
    ],
    reminders: [],
  },
  ...
  // INV-0006: CrossTown Printing, standalone, SENT ($3,200, due in 17d)
  {
    ...
    lineItems: [
      {
        id: 'd3c30601-e5f6-4a01-8b0c-0d1e2f3a4d0c',
        type: 'garment',
        description: 'Gildan 5000 — Black (200 pcs)',
        quantity: 200,
        unitPrice: 15.0,
        lineTotal: 3000,
      },
      {
        id: 'd3c30602-e5f6-4a01-8b0d-0d1e2f3a4d0d',
        type: 'setup',
        description: 'Screen setup — bulk run (2 colors)',
        quantity: 1,
        unitPrice: 100,
        lineTotal: 100,
      },
  ...
  // INV-0007: Metro Youth Soccer, standalone, PARTIAL ($2,100, $1,050 paid, due in 9d)
  {
    ...
    lineItems: [
      {
        id: 'd3c30701-e5f6-4a01-8b0e-0d1e2f3a4d0e',
        type: 'garment',
        description: 'Bella+Canvas 3001 — Royal Blue (100 pcs)',
        quantity: 100,
        unitPrice: 20.0,
        lineTotal: 2000,
      },
      {
        id: 'd3c30702-e5f6-4a01-8b0f-0d1e2f3a4d0f',
        type: 'setup',
        description: 'Screen setup — front (2 colors)',
        quantity: 1,
        unitPrice: 100,
        lineTotal: 100,
      },
  ...
  // INV-0008: TikTok Merch Co., standalone, VOID ($450)
  {
    ...
    lineItems: [
      {
        id: 'd3c30801-e5f6-4a01-9b01-0d1e2f3a4d10',
        type: 'garment',
        description: 'Bella+Canvas 3001 — Black (30 pcs)',
        quantity: 30,
        unitPrice: 12.5,
        lineTotal: 375,
      },
      {
        id: 'd3c30802-e5f6-4a01-9b02-0d1e2f3a4d11',
        type: 'setup',
        description: 'Screen setup — front (1 color)',
        quantity: 1,
        unitPrice: 40,
        lineTotal: 40,
      },
    ...
    auditLog: [
      ...
      { action: 'sent', performedBy: 'Gary', timestamp: '2026-02-02T09:00:00Z' },
      {
        ...
        performedBy: 'Gary',
        timestamp: '2026-02-05T14:00:00Z',
        details: 'Customer cancelled order',
      },
    ],
    reminders: [],
  },
...
export const payments: Payment[] = [
  ...
  {
    id: 'c2b20002-e5f6-4a02-9b02-0d1e2f3a4c02',
    invoiceId: INVOICE_IDS.inv0001,
    amount: 365,
    method: 'square',
    reference: 'SQ-4821',
  ...
  {
    id: 'c2b20003-e5f6-4a03-9b03-0d1e2f3a4c03',
  ...
  {
    id: 'c2b20004-e5f6-4a04-9b04-0d1e2f3a4c04',
    invoiceId: INVOICE_IDS.inv0004,
    amount: 500,
    method: 'venmo',
    reference: '@rivercitybrewing',
    date: '2025-12-15T14:00:00Z',
    createdAt: '2025-12-15T14:00:00Z',
  },
  {
    id: 'c2b20005-e5f6-4a05-9b05-0d1e2f3a4c05',
    invoiceId: INVOICE_IDS.inv0004,
    amount: 750,
    method: 'credit_card',
    reference: 'Visa ending 4821',
  ...
  {
    id: 'c2b20006-e5f6-4a06-9b06-0d1e2f3a4c06',
    invoiceId: INVOICE_IDS.inv0005,
    amount: 300,
    method: 'check',
    reference: 'Check #2088',
    date: '2026-02-05T10:00:00Z',
    createdAt: '2026-02-05T10:00:00Z',
  },
  {
    id: 'c2b20007-e5f6-4a07-9b07-0d1e2f3a4c07',
    invoiceId: INVOICE_IDS.inv0005,
    amount: 200,
    method: 'zelle',
    reference: 'sarah@lonestarlax.org',
  ...
  {
    id: 'c2b20008-e5f6-4a08-9b08-0d1e2f3a4c08',
    invoiceId: INVOICE_IDS.inv0007,
    amount: 500,
    method: 'ach',
    reference: 'ACH-20260201',
    date: '2026-02-01T10:00:00Z',
    createdAt: '2026-02-01T10:00:00Z',
  },
  {
    id: 'c2b20009-e5f6-4a09-9b09-0d1e2f3a4c09',
    invoiceId: INVOICE_IDS.inv0007,
    amount: 300,
    method: 'zelle',
    reference: 'coach@metroyouthsoccer.org',
    date: '2026-02-05T14:00:00Z',
    createdAt: '2026-02-05T14:00:00Z',
  },
  {
    id: 'c2b2000a-e5f6-4a0a-9b0a-0d1e2f3a4c0a',
    invoiceId: INVOICE_IDS.inv0007,
    amount: 150,
    method: 'ach',
    reference: 'ACH-20260208',
    date: '2026-02-08T10:00:00Z',
    createdAt: '2026-02-08T10:00:00Z',
  },
  {
    id: 'c2b2000b-e5f6-4a0b-9b0b-0d1e2f3a4c0b',
    invoiceId: INVOICE_IDS.inv0007,
    amount: 100,
    method: 'check',
    reference: 'Check #3301',
...
export const creditMemos: CreditMemo[] = [
    ...
    lineItems: [
      {
        ...
        description: 'Gildan 18500 Hoodie — Forest Green (3 short)',
        quantity: 3,
        unitCredit: 32,
        lineTotal: 96,
      },
  ...
  // CM-0002: Misprint on INV-0001 (River City Staff Tees)
  {
    ...
    lineItems: [
      {
        id: 'f6e60002-e5f6-4a02-8b02-0d1e2f3a5002',
        description: 'Gildan 5000 — Black (5 misprinted)',
        quantity: 5,
        unitCredit: 14.5,
        lineTotal: 72.5,
      },
...
export const quoteCards: QuoteCard[] = [
  // Q-1035: Ready — new phone lead, no quote yet
  {
    ...
    notes: [
      {
        content: 'Coach called during lunch — wants pricing for 60+ varsity jerseys',
        type: 'internal',
      },
    ],
  },
  ...
  // Q-1037: Blocked — Sunset 5K, waiting on customer to pick color
  {
    ...
    notes: [
      ...
      {
        content: "We're between neon yellow and safety orange, will decide by Friday",
        type: 'customer',
      },
    ],
  },
  // Q-1038: Done — Lonestar Lacrosse, accepted, "New" badge
  {
    ...
    notes: [
      {
        content: 'Need separate numbering for each team — confirm roster by Feb 18',
        type: 'internal',
      },
...
export function getCustomerNotes(customerId: string): Note[] {
  return customerNotes.filter((n) => n.entityType === 'customer' && n.entityId === customerId)
}
