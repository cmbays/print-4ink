...
export function ScreenPrintEditor({ templateId }: ScreenPrintEditorProps) {
  ...
  const sourceTemplate = allScreenPrintTemplates.find((t) => t.id === templateId)
  ...
  // ── Derived values ────────────────────────────────────────────────
  const colorHitRate = template.matrix.colorPricing[0]?.ratePerHit ?? 1.5
                ...
                <PopoverContent className="w-72" align="end">
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      <Label htmlFor="sf-per-screen" className="text-xs">
                        Per-screen fee
                      </Label>
                      <div className="relative w-full">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateSetupFees('perScreenFee', parseFloat(e.target.value) || 0)
                          }
                    ...
                    <div className="space-y-1">
                      <Label htmlFor="sf-bulk-waiver" className="text-xs">
                        Bulk waiver (qty)
                      </Label>
                      <Input
                        id="sf-bulk-waiver"
                        ...
                        onChange={(e) =>
                          updateSetupFees('bulkWaiverThreshold', parseInt(e.target.value) || 0)
                        }
                        onFocus={(e) => e.target.select()}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        <Label htmlFor="sf-reorder-window" className="text-xs">
                          Window (mo)
                        </Label>
                        <Input
                          ...
                          onChange={(e) =>
                            updateSetupFees('reorderDiscountWindow', parseInt(e.target.value) || 0)
                          }
                          onFocus={(e) => e.target.select()}
                          className="h-7 text-xs"
                        />
                      ...
                      <div className="space-y-1">
                        <Label htmlFor="sf-reorder-pct" className="text-xs">
                          Discount
                        </Label>
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Reorders within {fees.reorderDiscountWindow}mo get{' '}
                      {fees.reorderDiscountPercent}% off setup
                    </p>
                  </div>
                </PopoverContent>
              </Popover>
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {editorMode === 'power' && (
                  <WithTooltip
                    tooltip={
                      isManualEditOn ? 'Exit manual editing mode' : 'Tap cells to set custom prices'
                    }
                  >
                    <Button
