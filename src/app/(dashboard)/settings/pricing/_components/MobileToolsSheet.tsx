...
const toolItems: Array<{
  ...
  { id: "qty-tiers", icon: Layers, label: "Qty Tiers", description: "Quantity breakpoints & base pricing", drillDown: true },
  { id: "garments", icon: Shirt, label: "Garments", description: "Markup by garment category", drillDown: true },
  { id: "locations", icon: MapPin, label: "Locations", description: "Per-piece location upcharges", drillDown: true },
  { id: "setup-fees", icon: Receipt, label: "Setup Fees", description: "Screen fees & reorder discounts", drillDown: true },
];
...
const actionItems: Array<{
  ...
  { icon: Copy, label: "Duplicate", description: "Create a copy of this template", action: "duplicate" },
  { icon: Trash2, label: "Delete", description: "Remove this template", variant: "destructive", action: "delete" },
];
            ...
            <div className="flex flex-col gap-1 px-4 pb-4">
              ...
              {toolItems.map((tool) => {
                ...
                return (
                  ...
                  >
                    <Icon className={cn("size-5 shrink-0", hasError ? "text-error" : "text-muted-foreground")} />
                    <div className="flex-1 min-w-0">
                      <p className={cn("text-sm font-medium", hasError && "text-error")}>{tool.label}</p>
  ...
  return (
    <div className="space-y-3">
      <div className="space-y-1">
        <Label htmlFor="mobile-sf-per-screen" className="text-xs">Per-screen fee</Label>
      ...
      <div className="space-y-1">
        <Label htmlFor="mobile-sf-bulk-waiver" className="text-xs">Bulk waiver (qty)</Label>
        <Input
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="space-y-1">
          <Label htmlFor="mobile-sf-reorder-window" className="text-xs">Window (mo)</Label>
          <Input
        ...
        <div className="space-y-1">
          <Label htmlFor="mobile-sf-reorder-pct" className="text-xs">Discount</Label>
