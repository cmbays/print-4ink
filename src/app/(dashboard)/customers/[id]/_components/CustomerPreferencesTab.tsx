...
export function CustomerPreferencesTab({
  ...
  const inheritMode: InheritanceMode =
    customer.favoriteColors.length > 0 ? "customize" : "inherit";

  // Resolve parent label for InheritanceToggle
  const parentLabel =
    customer.favoriteBrandNames.length > 0
      ? customer.favoriteBrandNames[0]
      : "global";
