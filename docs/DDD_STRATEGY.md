...
| ----------------------- | ------------------------------------------------ | ----------------------------------- |
| **User says...**        | "I need to go **do** a \_\_\_"                   | "I need to **set up** my \_\_\_"    |
...
2. Does a customer say "I need to go DO a \_\_\_"? **Yes** — "I need to check my order status", "I need to approve artwork."
