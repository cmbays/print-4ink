...
```tsx
<Button className="bg-action text-black font-semibold border-2 border-current shadow-[4px_4px_0px] shadow-cyan-400 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px] active:translate-x-0 active:translate-y-0 active:shadow-[2px_2px_0px] transition-all">
  New Quote
</Button>
```
...
<div className="rounded-lg border-2 border-border bg-card p-6 cursor-pointer transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[4px_4px_0px] hover:shadow-cyan-400 hover:border-action">
  ...
</div>
```
