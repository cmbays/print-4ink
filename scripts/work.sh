...
CONTEXT
    ...
    # Write per-worktree direnv environment
    # CLAUDE_SESSION_ID is empty now — poller updates it after Claude starts.
    cat > "${WORKTREE_DIR}/.envrc" <<ENVRC
# Auto-generated by work — do not edit manually
export PORT=${PORT}
export WORK_TOPIC="${TOPIC}"
export WORK_BRANCH="${BRANCH}"
export WORK_PIPELINE_ID=""
export WORK_PIPELINE_STAGE=""
export CLAUDE_SESSION_ID=""
ENVRC

    # Allow direnv to load this .envrc automatically (writes to ~/.local/share/direnv/allow/)
